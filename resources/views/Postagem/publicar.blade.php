...
@section('content')
    ...
    <form class="m-lg-5 shadow-lg">
            ...
            <div class="form-group col-md-3">
                ...
                /> -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-file-earmark-plus-fill card-img-top m-md-auto" viewBox="0 0 16 16">
                        <path
        ...
        <div class="form-row">
            <div class="form-group col-md-12 text-center">
                <button type="button" class="btn btn-salvar btn-lg disabled">
                    Salvar
                </button>
                <button type="button" class="btn btn-cancelar btn-lg disabled">
                    Cancelar
                </button>
            </div>
        </div>
